    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
                        ...
                        @else
                            <div class="list-group">
                                @foreach ($course->lessons as $lesson)
                                    <div
                                        class="list-group-item list-group-item-action d-flex align-items-center p-3 mb-2 border rounded-3">
            ...
            <div class="col-lg-4">
                ...
                {{-- Thêm vào trang show.blade.php của course --}}
                <div class="btn-group">
                    <a href="{{ route('teacher.courses.edit', $course) }}" class="btn btn-outline-primary">
                        <i class="bi bi-pencil me-1"></i> Sửa
                    </a>
                    <a href="{{ route('teacher.courses.students.pending', $course) }}" class="btn btn-warning">
                        <i class="bi bi-person-check me-1"></i> Duyệt học viên
                        @php
                            $pendingCount = $course->students()->wherePivot('status', 'pending')->count();
                        @endphp
                        @if ($pendingCount > 0)
